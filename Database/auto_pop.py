...
#     logging.info(f"Total EOX Devices: {len(eox_devices)}.")
#     logging.info(f"Total EOX Links: {len(eox_links)}.")
#     logging.info(f"Starting EOX Scrapping Process for {len(eox_devices)} devices.")
#     eox_data = {}
...
#     logging.info(f"Total EOX Data Retrieved: {len(eox_data)}.")
