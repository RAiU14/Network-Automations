...
def find_device_series_link(pid: str, technology: str):
    try:
        logging.info(f"Starting Device Series Link retreival process for PID: {pid} under Technology: {technology}")
        data = {}
        ...
        if technology == "Routing and Switching":
            ...
            for tech in categories:
                logging.debug(f"Searching under Technology: {tech}")
