...
# --- dual-mode import for IOS_XE_Stack_Switch ---
try:
    from . import IOS_XE_Stack_Switch  # when inside a package
except Exception:
    import IOS_XE_Stack_Switch  # when run/imported standalone
# ------------------------------------------------
